...
public class WeaponAttachmentSystemUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        rifleABodyButton.onClick.AddListener(() => {
            WeaponAttachmentSystem.Instance.SetWeaponBody(weaponBodyListSO.akWeaponBodySO);
        });
        rifleBBodyButton.onClick.AddListener(() => {
            WeaponAttachmentSystem.Instance.SetWeaponBody(weaponBodyListSO.coltWeaponBodySO);
        });
        ...
        playButton.onClick.AddListener(() => {
            WeaponAttachmentSystemGame.WeaponCompleteJason = WeaponAttachmentSystem.Instance.GetWeaponComplete().Save();
